 ...
 * @author Tarcísio
 */
public class JFCONBloco extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Condomínio Express  |  Consulta Blocos");
        ...
        jLabel2.setText("Pesquise por bloco:");
 ...
 JFCADBloco JFCADBloco = new  JFCADBloco ();
 JFMenu.jDesktop.add(JFCADBloco);
JFCADBloco.setVisible(true);
JFCADBloco.setPosicao(); 
JFCONBloco.this.dispose();
    }//GEN-LAST:event_jButtonaddActionPerformed

    private void jButtonalterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonalterarActionPerformed
 JFEDITBloco EDITBloco = new    JFEDITBloco ();
 JFMenu.jDesktop.add(EDITBloco);
EDITBloco.setVisible(true);
EDITBloco.setPosicao(); 
JFCONBloco.this.dispose();
    }//GEN-LAST:event_jButtonalterarActionPerformed

    private void jButtondeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtondeletarActionPerformed
int resposta = JOptionPane.showConfirmDialog(this, "Deseja realmente excluir o bloco selecionado?", "Confirmação",  
      JOptionPane.YES_NO_OPTION);  
      if (resposta == JOptionPane.YES_OPTION){  
    
 
JOptionPane.showMessageDialog(this, "Bloco excluido com sucesso!"); 
}else{  
          JOptionPane.showMessageDialog(this, "Selecione um Bloco  para exclusão");  
