 ...
 * @author Tarcísio
 */
public class JFCONApartamentos extends javax.swing.JInternalFrame {

    /**
     * Creates new form JFCONCondomino
     */
    public JFCONApartamentos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Condomínio Express  |  Consulta Apartamentos");
        ...
        jLabel2.setText("Pesquise por numero do apartamento:");
 ...
 JFCADApartamento JFCADapt = new  JFCADApartamento();
 JFMenu.jDesktop.add(JFCADapt);
JFCADapt.setVisible(true);
JFCADapt.setPosicao(); 
JFCONApartamentos.this.dispose();
    }//GEN-LAST:event_jButtonaddActionPerformed

    private void jButtonalterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonalterarActionPerformed
 JFEDITApartamento JFEDITApt = new  JFEDITApartamento();
 JFMenu.jDesktop.add(JFEDITApt);
JFEDITApt .setVisible(true);
JFEDITApt .setPosicao(); 
JFCONApartamentos.this.dispose();
