 ...
 * @author Tarcísio
 */
public class JFCONPrestador extends javax.swing.JInternalFrame {

    /**
     * Creates new form JFCONCondomino
     */
    public JFCONPrestador() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Condomínio Express  |  Consulta Prestador de Serviços");
...
JFCADPrestador JFCADPrest = new   JFCADPrestador ();
JFMenu.jDesktop.add(JFCADPrest);
JFCADPrest.setVisible(true);
JFCADPrest.setPosicao(); 
JFCONPrestador.this.dispose();
    }//GEN-LAST:event_jButtonaddActionPerformed

    private void jButtonalterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonalterarActionPerformed
JFEDITPrestador JFEDITPrest = new   JFEDITPrestador();
JFMenu.jDesktop.add(JFEDITPrest);
JFEDITPrest .setVisible(true);
JFEDITPrest.setPosicao(); 
JFCONPrestador.this.dispose();
    }//GEN-LAST:event_jButtonalterarActionPerformed

    private void jButtondeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtondeletarActionPerformed
int resposta = JOptionPane.showConfirmDialog(this, "Deseja realmente excluir o prestador de serviço selecionado?", "Confirmação",  
      JOptionPane.YES_NO_OPTION);  
      if (resposta == JOptionPane.YES_OPTION){  
    
 
JOptionPane.showMessageDialog(this, "Prestador de serviço  excluido com sucesso!"); 
}else{  
          JOptionPane.showMessageDialog(this, "Selecione um prestador de serviço  para exclusão");  
