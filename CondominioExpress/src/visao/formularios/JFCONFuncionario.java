 ...
 * @author Tarcísio
 */
public class JFCONFuncionario extends javax.swing.JInternalFrame {

    /**
     * Creates new form JFCONCondomino
     */
    public JFCONFuncionario() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pesquise pelo nome do funcionário");
 ...
 JFCADFuncionario CADFuncionario  = new JFCADFuncionario();
JFMenu.jDesktop.add(CADFuncionario);
CADFuncionario.setVisible(true);
CADFuncionario.setPosicao(); 
JFCONFuncionario.this.dispose();
