 ...
 * @author Tarcísio
 */
public class JFCONOcorrencia extends javax.swing.JInternalFrame {

    /**
     * Creates new form JFCONCondomino
     */
    public JFCONOcorrencia() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Digite o numero da ocorrência");
 ...
 JFCADOcorrencia CADOcorrencia  = new JFCADOcorrencia ();
JFMenu.jDesktop.add(CADOcorrencia);
CADOcorrencia.setVisible(true);
CADOcorrencia.setPosicao(); 
JFCONOcorrencia.this.dispose();
